...
vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(event)
        ...
        if client and client.name == "clangd" then
            local opts = { noremap = true, silent = true, buffer = event.buf, desc = 'C++: Switch between source and header file' }
            vim.keymap.set('n', '<leader>lj', '<cmd>LspClangdSwitchSourceHeader<CR>', opts)
        end
    end,
